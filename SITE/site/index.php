	...
	<form method="post" action="index.php">
		...
		<?php
			if(isset($_POST['Run_btn']))
			{
				...
				$xmlObject = $xmlDoc->getElementsByTagName('game');
				$itemCount = $xmlObject->length;

				for ($i=0; $i < $itemCount; $i++){
					$games = $xmlObject->game($i)->getElementsByTagName('games')->game(0)->childNodes->game(0)->nodeValue;
					$sql   = "INSERT INTO `GameInfo` (GameName) VALUES ('$games')";
					mysql_query($sql);
					echo "Finished Item $games n<br/>";
				}
			}
